...
export default function UserPortalPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-gradient-to-br from-blue-50 via-white to-blue-100 relative overflow-x-hidden">
      ...
      <p className="text-lg sm:text-xl text-blue-500 text-center mb-10 font-medium animate-fadeIn">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 w-full max-w-4xl animate-fadeInUp">
        {categories.map((item, idx) => (
          ...
          >
            <Link
              href="/Sauna"
              className="bg-blue-100 rounded-3xl w-28 h-32 flex items-center justify-center shadow-md border-2 border-transparent group-hover:border-gray-400 group-hover:shadow-xl group-hover:scale-105 transition-all duration-300"
            >
            ...
            <p className="mt-4 text-center font-semibold text-gray-800 group-hover:text-blue-500 transition-colors duration-300">
              {item.name}
            </p>
          </div>
        ))}
